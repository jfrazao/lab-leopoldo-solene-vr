...
% Catch #2 - Omission of 2nd grating with Opto at the 2nd grating location
trials(3,:) = {3, text0, 'fwn1', text2, 1, 380, 170};

% Catch #3 - Omission of 2nd grating without Opto
trials(4,:) = {4, text0, 'fwn1', text2, 1, 380, 500};
...
%Save
writetable(table_trials,'TrialSequence_Goncalo_ultimate_4thCorridor_2ndVersion.csv.csv')
