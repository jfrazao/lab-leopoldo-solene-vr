...
randvec = randi([0 1],par.number_trials,1);
trials.tex_Stim_Left(randvec==1 & leftrelevanttrials==0)                        = {par.tex_C}; 
trials.tex_Stim_Right(randvec==1 & leftrelevanttrials==1)                       = {par.tex_C}; 

trials.tex_Stim_Left(randvec==0 & leftrelevanttrials==0)                        = {par.tex_D}; 
trials.tex_Stim_Right(randvec==0 & leftrelevanttrials==1)                       = {par.tex_D}; 
